...
<p id="viz-generated" class="viz-footnote" style="margin-top:0"></p>
...
<div id="viz-body" data-viz-summary>
...
<figure class="viz-figure">
  <div class="viz-figure-head">
    ...
    <p class="viz-figure-note">Each point is one activity. Faster is higher — the pace axis is reversed so that up means quicker.</p>
  </div>
...
</div><!-- /viz-body: everything summary.json drives, part one -->
...
-->
<section id="forecast-section" hidden>

<h2>Forecast</h2>

<p class="viz-figure-note" id="forecast-meta" style="margin-bottom:0.4em"></p>
<p class="viz-figure-note" id="forecast-generated" style="margin-top:0"></p>
<p class="viz-callout" id="forecast-warning" hidden></p>

<div class="viz-records">
  <div class="viz-record">
    <span class="viz-record-label">Trend</span>
    <span class="viz-record-value" id="forecast-trend">–</span>
    <span class="viz-record-meta" id="forecast-trend-meta"></span>
  </div>
  <div class="viz-record">
    <span class="viz-record-label">Cost of climbing</span>
    <span class="viz-record-value" id="forecast-climb">–</span>
    <span class="viz-record-meta" id="forecast-climb-meta"></span>
  </div>
  <div class="viz-record">
    <span class="viz-record-label">Underlying pace</span>
    <span class="viz-record-value" id="forecast-level">–</span>
    <span class="viz-record-meta" id="forecast-level-meta"></span>
  </div>
  <div class="viz-record">
    <span class="viz-record-label">Next session</span>
    <span class="viz-record-value" id="forecast-next">–</span>
    <span class="viz-record-meta" id="forecast-next-meta"></span>
  </div>
</div>
...
<figure class="viz-figure">
  ...
  <div class="viz-params">
    ...
    <p class="viz-figure-note" id="fit-arma" style="padding:0.6em 1.1em 0"></p>
  </div>
  <details class="viz-table-toggle">
...
<figure class="viz-figure">
  ...
  <div class="viz-params">
    ...
    <p class="viz-figure-note" id="fit-llt" style="padding:0.6em 1.1em 0"></p>
  </div>
  <details class="viz-table-toggle">
    <summary>Show forecast table</summary>
...
<div data-viz-summary><!-- everything summary.json drives, part two -->
